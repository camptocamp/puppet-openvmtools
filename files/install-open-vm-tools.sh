...
if [ "$VER" == "2009.07.22-179896" ]; then
  wget -nv -O $WORKDIR/open-vm-tools-${VER}/patch-989708.patch "sourceforge.net/p/open-vm-tools/tracker/_discuss/thread/76caf06a/13ce/attachment/tmp.patch"  >$BUILDLOG 2>&1 || exit 1
